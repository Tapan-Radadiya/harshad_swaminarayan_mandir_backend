...
export interface ApiImageManagerImageManager
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    image_type: Schema.Attribute.Enumeration<
      ['carousel', 'gallery', 'section_banner']
    > &
      Schema.Attribute.Required;
...
export interface ApiMandirEventMandirEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    event_type: Schema.Attribute.Enumeration<
      ['Festival', 'Pooja', 'Celebration', 'Yatra']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    shot_description: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::image-manager.image-manager': ApiImageManagerImageManager;
      'api::mandir-event.mandir-event': ApiMandirEventMandirEvent;
